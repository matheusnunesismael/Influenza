...
/*
  Construtor da classe Parâmetros. 
...
/*
  ...
  têm a mesma estrutura, somente um método é necessário. 
...
/*
  ...
  e "Entradas/MonteCarlo_{1}/Simulacao" por meio das chamadas ao método 
  "lerArquivo". Os arquivos lidos são: 
